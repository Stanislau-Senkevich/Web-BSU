...
INSERT INTO park_user (id, login, password)
...
INSERT INTO driver (id, name, surname, birthdate)
VALUES (1, 'John', 'Doe', '1980-01-15'),
       (2, 'Jane', 'Smith', '1975-03-22'),
       (3, 'Robert', 'Johnson', '1983-07-30'),
       (4, 'Emily', 'Davis', '1990-05-14'),
       (5, 'Michael', 'Wilson', '1985-11-20'),
       (6, 'Sarah', 'Taylor', '1988-02-10'),
       (7, 'David', 'Clark', '1992-08-05'),
       (8, 'Jessica', 'Moore', '1981-04-17'),
       (9, 'Thomas', 'Lewis', '1979-12-11'),
       (10, 'Karen', 'Walker', '1986-06-23');

-- Insert into dispatcher table
INSERT INTO dispatcher (id, name, surname, birthdate)
VALUES (1, 'George', 'Martin', '1971-07-10'),
       (2, 'Sophia', 'Brown', '1968-02-21'),
       (3, 'Oliver', 'Adams', '1982-09-25'),
       (4, 'Amelia', 'Thomas', '1976-10-30'),
       (5, 'Mason', 'Harris', '1984-06-13');
